...
public class FlowerDAOImpl implements FlowerDAO {
    ...
    private static final String SQL_UPDATE_FLOWER3 = "sqlUpdateFlower3";
    ...
    @Override
    public void updateFlower(int key, GeneralFlower flower) throws SQLException {
        try (Connection conn = connectionPool.getConnection();
             PreparedStatement pst = conn.prepareStatement(sql.getProperty(SQL_UPDATE_FLOWER3))
        ) {
            pst.setInt(1, flower.getLength());
            pst.setInt(2, flower.getFreshness().getFreshness());
            pst.setFloat(3, flower.getPrice());
            pst.setInt(4, key);
